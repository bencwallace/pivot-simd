...
//     EXPECT_EQ(b2.intervals()[0].right_, 1);

//     auto b3 = box(std::array{p2, p1});
//     EXPECT_EQ(b3.intervals()[0].left_, 1);
//     EXPECT_EQ(b3.intervals()[0].right_, 3);

//     auto p3 = point<1>({-2});
//     auto b4 = box(std::array{p1, p2, p3});
//     EXPECT_EQ(b4.intervals()[0].left_, -4);
//     EXPECT_EQ(b4.intervals()[0].right_, 1);

//     auto b5 = box(std::array{p3, p2, p1});
//     EXPECT_EQ(b5.intervals()[0].left_, 1);
//     EXPECT_EQ(b5.intervals()[0].right_, 6);

//     auto p4 = point<1>({0});
//     auto b6 = box(std::array{p1, p2, p3, p4});
//     EXPECT_EQ(b6.intervals()[0].left_, -4);
//     EXPECT_EQ(b6.intervals()[0].right_, 1);
// }
...
//     auto b7 = b1 | b6;
//     EXPECT_EQ(b7.intervals()[0].left_, -1);
//     EXPECT_EQ(b7.intervals()[0].right_, 1);
// }
